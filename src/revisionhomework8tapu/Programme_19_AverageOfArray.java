...
public class Programme_19_AverageOfArray {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Value of the element of the Arrays are :  " + Arrays.toString(numArray));
        System.out.println("Average  of all the value of the arrays are : " + average);
    }
}
